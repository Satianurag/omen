"""The Major Arcana of omen: a card for each workflow phase.
...
a card at each step; ``omen arcana`` prints the full spread.
"""
...
ARCANA: dict[str, tuple[str, str, str]] = {
    ...
    "signoz_preflight": ("IX", "The Hermit", "A lantern into SigNoz before the reading."),
    "correlate": ("VI", "The Lovers", "Client and server are joined over one window."),
    "detect_anomalies": (
        "XVII",
        "The Star",
        "SigNoz aggregate_traces p95 time_series over the test window; where the load breaches the band is revealed.",
    ),
    "analyze": (
        "XIX",
        "The Sun",
